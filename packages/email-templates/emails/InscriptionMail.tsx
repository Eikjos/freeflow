    ...
    <TailwindConfig>
      ...
      <div className="mt-5 px-8">
        <Text className="text-center text-2xl mx-auto mt-10 mb-5">
          Bienvenue sur Freeflow, la plateforme qui simplifie la gestion de
          votre entreprise !
        </Text>
        <Text>
        ...
        <ul className="text-sm font-display">
          ...
          <li>Visualiser vos indicateurs clés en un coup d’œil</li>
          <li>
            Optimiser du temps sur la création de facture et sur la comptabilitê
          </li>
        </ul>
        <Text className="text-center mx-auto text-xl mt-10">
          Pour commencer, cliquez sur le bouton ci-dessous pour accéder à votre
          tableau de bord
        </Text>
        <div className="mt-10 text-center">
          <Button
            className="bg-primary px-6 py-2 rounded-full text-sm text-white w-44 inline-block"
        ...
        <Text className="mt-10 text-nowrap">
          Si vous n’avez pas créé ce compte, ignorez simplement ce message ou
          contactez notre support. Merci de nous rejoindre et bonne découverte
          de Freeflow !
        </Text>
        <Text>
          Cordialement,
