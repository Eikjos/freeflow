    ...
    <div className="px-4 py-2">
      ...
      >
        ...
        <div className="flex flex-col gap-3 order-1">
          <KPICard value={ sale.data ?? 0 } title={t("common.sales")} type="sale" />
          <KPICard value={ customer.data ?? 0 } title={t("common.customers")} type="default" />
          <KPICard value={ project.data ?? 0 } title={t("common.projects")} type="default" />
        </div>
