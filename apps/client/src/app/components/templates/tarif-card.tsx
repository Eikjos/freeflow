        ...
        <div>
          <ul className="px-1 text-sm font-extralight">
            <li className="flex flex-row items-center gap-3">
              ...
              {maxUser == -1
                ? t('landing.prices.cards.customerInfinite')
                : t('landing.prices.cards.customerMax', {
                    nbCutomers: maxUser,
                  })}
            </li>
            <li className="flex flex-row items-center gap-3">
              <Check className="w-4 h-4 text-primary flex-shrink-0" />{' '}
              {t('landing.prices.cards.projectInfinite')}
            </li>
            <li className="flex flex-row items-center gap-3">
              <Check className="w-4 h-4 text-primary flex-shrink-0" />{' '}
              {t('landing.prices.cards.manageCallback')}
            </li>
            <li className="flex flex-row items-center gap-3">
              <Check className="w-4 h-4 text-primary flex-shrink-0" />{' '}
              {t('landing.prices.cards.opinionFeature')}
            </li>
            <li className="flex flex-row items-center gap-3">
              <Check className="w-4 h-4 text-primary flex-shrink-0" />{' '}
              {t('landing.prices.cards.mcp')}
            </li>
          </ul>
        </div>
        <div className="text-center">
          <Button
            className="w-3/4 mt-10 mb-5 mx-auto rounded-3xl flex flex-row"
            asChild
          >
