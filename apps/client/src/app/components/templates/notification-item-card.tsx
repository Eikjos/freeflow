...
export default function NotifcationItemCard({ className } : NotificationItemCardProps) {
  return (
    <Card className={cn("h-20",className)}>
      <CardContent className="p-1 relative">
        <CardHeader className="p-1 text-primary">Altitude Infra Exploitation</CardHeader>
